...
var reduxForm = exports.reduxForm = function reduxForm(config, mapStateToProps, mapDispatchToProps, mergeProps, options) {
  return function (WrappedComponent) {
    ...
    return (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps, mergeProps, options)((0, _reduxForm.reduxForm)(mconfig)(ReduxFormCompat(mconfig, WrappedComponent)));
  };
};